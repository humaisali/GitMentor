      ...
      <header className="flex justify-between items-end mb-2 shrink-0 animate-fade-in-up">
        <div>
          <h1 className="text-3xl font-semibold tracking-tight text-canvas-white">
            <span className="bg-gradient-to-r from-muted-cyan to-blue-400 bg-clip-text text-transparent">Analytics</span>
          </h1>
      ...
      {loading ? (
        ...
        <div className="flex-1 pr-2 pb-10">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 auto-rows-min">
            ...
            {/* ROW 1: Shape 1 */}
            <div className="xl:col-span-3 md:col-span-2 col-span-1 animate-fade-in-up stagger-1">
              <ContributionCalendarWidget initialData={data.contributions} className="px-5 py-4" />
            </div>
            ...
            <Card className="xl:col-span-1 md:col-span-1 col-span-1 p-6 h-full flex flex-col animate-fade-in-up stagger-2">
              ...
              <div className="flex h-3 rounded-full overflow-hidden mb-6 glass-surface shrink-0 p-0 border-0" style={{ borderRadius: '9999px' }}>
                {data.languages.map(lang => (
                  <div 
                    key={lang.name} 
                    style={{ width: `${lang.percentage}%`, backgroundColor: lang.color || '#94A3B8' }}
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-3 flex-1 content-start">
                {data.languages.map(lang => (
                  <div key={lang.name} className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full shrink-0" style={{ backgroundColor: lang.color || '#94A3B8' }} />
            ...
            <Card className="xl:col-span-2 md:col-span-1 col-span-1 p-6 flex flex-col justify-between h-full animate-fade-in-up stagger-3">
              ...
              <div className="grid grid-cols-2 gap-3 h-full">
                <div className="glass-surface p-4 flex flex-col items-center justify-center text-center transition-all duration-300 hover:border-muted-cyan/20 hover:shadow-[0_0_15px_rgba(88,166,255,0.1)] hover:-translate-y-0.5">
                  <div className="text-3xl font-bold text-muted-cyan mb-1">{data.contributions.currentStreak} <span className="text-sm font-normal">days</span></div>
                  <div className="text-muted-steel text-xs font-mono tracking-wider">CURRENT</div>
                </div>
                <div className="glass-surface p-4 flex flex-col items-center justify-center text-center transition-all duration-300 hover:border-muted-cyan/20 hover:shadow-[0_0_15px_rgba(88,166,255,0.1)] hover:-translate-y-0.5">
                  <div className="text-3xl font-bold text-canvas-white mb-1">{data.contributions.longestStreak} <span className="text-sm font-normal">days</span></div>
                  <div className="text-muted-steel text-xs font-mono tracking-wider">LONGEST</div>
                </div>
              </div>
            </Card>

            {/* ROW 3: Shape 4 & Shape 5/6 */}
            <div className="xl:col-span-3 md:col-span-2 col-span-1 grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fade-in-up stagger-4">
                ...
                <Card className="p-6 h-full flex flex-col">
                  ...
                  <div className="flex flex-col gap-3 flex-1 overflow-y-auto custom-scrollbar">
                    {data.featuredRepos.length > 0 ? data.featuredRepos.map(repo => (
                      <a key={repo.name} href={repo.url} target="_blank" rel="noreferrer" className="block glass-surface p-4 hover:border-muted-cyan/20 hover:shadow-[0_0_15px_rgba(88,166,255,0.08)] hover:-translate-y-0.5 transition-all duration-300 shrink-0">
              ...
              <div className="flex flex-col gap-6 h-full">
                <Card className="p-6 flex flex-col justify-between shrink-0">
                  <h2 className="text-lg font-medium text-canvas-white tracking-tight mb-6 flex items-center gap-2.5">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="glass-surface p-4 flex flex-col justify-center transition-all duration-300 hover:border-muted-cyan/20 hover:shadow-[0_0_15px_rgba(88,166,255,0.1)] hover:-translate-y-0.5">
                      <div className="text-muted-steel text-xs font-mono mb-1 tracking-wider">STARS EARNED</div>
                      <div className="text-2xl font-semibold text-canvas-white">{data.overview.totalStars}</div>
                    </div>
                    <div className="glass-surface p-4 flex flex-col justify-center transition-all duration-300 hover:border-muted-cyan/20 hover:shadow-[0_0_15px_rgba(88,166,255,0.1)] hover:-translate-y-0.5">
                      <div className="text-muted-steel text-xs font-mono mb-1 tracking-wider">TOTAL FORKS</div>
                      <div className="text-2xl font-semibold text-canvas-white">{data.overview.totalForks}</div>
                    </div>
                    <div className="glass-surface p-4 flex flex-col justify-center transition-all duration-300 hover:border-muted-cyan/20 hover:shadow-[0_0_15px_rgba(88,166,255,0.1)] hover:-translate-y-0.5">
                      <div className="text-muted-steel text-xs font-mono mb-1 tracking-wider">FOLLOWERS</div>
                      <div className="text-2xl font-semibold text-canvas-white">{data.overview.followers}</div>
                    </div>
                    <div className="glass-surface p-4 flex flex-col justify-center transition-all duration-300 hover:border-muted-cyan/20 hover:shadow-[0_0_15px_rgba(88,166,255,0.1)] hover:-translate-y-0.5">
                      <div className="text-muted-steel text-xs font-mono mb-1 tracking-wider">PRs / ISSUES</div>
            ...
            <div className="xl:col-span-3 md:col-span-2 col-span-1 animate-fade-in-up stagger-6">
              <Card hover={false} className="p-8 h-full flex flex-col relative overflow-hidden shadow-elevation-3">
                <div className="absolute top-0 right-0 w-96 h-96 bg-muted-cyan/[0.04] rounded-full blur-[100px] pointer-events-none -translate-y-1/2 translate-x-1/3 animate-blob"></div>
                <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-500/[0.04] rounded-full blur-[100px] pointer-events-none translate-y-1/2 -translate-x-1/3 animate-blob-delay-2"></div>
                
                <h2 className="text-2xl font-semibold text-canvas-white tracking-tight mb-2 flex items-center gap-3 relative z-10">
                  <div className="w-10 h-10 rounded-xl bg-muted-cyan/10 flex items-center justify-center border border-muted-cyan/20 shadow-[0_0_15px_rgba(88,166,255,0.15)]">
                    <Trophy size={20} className="text-muted-cyan" />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 relative z-10">
                  {BADGES.map(badge => {
                    ...
                    return (
                      <div key={badge.id} className={`flex gap-5 p-6 rounded-2xl border transition-all duration-300 backdrop-blur-sm ${isUnlocked ? 'bg-white/[0.04] border-muted-cyan/20 shadow-[0_0_20px_rgba(88,166,255,0.1)] hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(88,166,255,0.15)] ' + badge.glow : 'bg-white/[0.02] border-white/[0.06] opacity-60 grayscale'}`}>
                        <div className={`shrink-0 w-14 h-14 rounded-full flex items-center justify-center border ${isUnlocked ? 'bg-muted-cyan/10 border-muted-cyan/30 shadow-[0_0_15px_rgba(88,166,255,0.15)] ' + badge.color : 'bg-white/[0.03] border-white/[0.08] text-muted-steel'}`}>
                        ...
                        <div className="flex-1 flex flex-col justify-center">
                          ...
                          {isUnlocked && (
                            <div className="inline-block px-2.5 py-1 bg-white/[0.04] border border-white/[0.08] rounded-full text-[11px] font-mono text-muted-cyan self-start">
