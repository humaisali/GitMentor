        ...
        <div className="flex justify-between items-start gap-4">
          ...
          <div className="flex flex-col items-end gap-3 shrink-0">
            ...
            {project.selectedTimeline && (
              <Button 
                variant="primary" 
                className="px-6 py-2.5 text-sm font-medium rounded-xl shadow-lg shadow-muted-cyan/20 gap-2"
      ...
      {(!project.detailedPlan || !project.detailedPlan.scope) ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 auto-rows-min">
          ...
          {project.selectedTimeline && (
            <>
              {/* Active Timeline */}
              <div className="md:col-span-8 bg-muted-surface rounded-2xl p-7 shadow-lg relative overflow-hidden flex flex-col justify-center">
                ...
                <div className="inline-block px-3 py-1 bg-muted-surface rounded-full border border-whisper/50 text-xs text-muted-cyan font-mono mb-5 self-start">
              ...
              <div className="md:col-span-4 bg-muted-surface rounded-2xl p-8 shadow-xl shadow-muted-cyan/5 relative overflow-hidden flex flex-col justify-center items-center text-center gap-6">
                <div className="absolute top-0 right-0 w-40 h-40 bg-muted-cyan/5 rounded-full blur-3xl pointer-events-none -translate-y-1/2 translate-x-1/2"></div>
                ...
                <Button 
                  variant="primary" 
                  className="w-full py-3.5 text-sm font-medium rounded-xl shadow-lg shadow-muted-cyan/20 gap-2 relative z-10"
                  onClick={handleContinueProject}
                >
